...
customer_last_name
,customer_first_name
,ROUND(SUM(quantity*cost_to_customer_per_qty),2) as amt_spent
...
,STRFTIME('%m',market_date) as month
,STRFTIME('%Y',market_date) as year
,SUM(quantity*cost_to_customer_per_qty) as amt_spent
FROM customer_purchases
...
SELECT
customer_id
,STRFTIME('%m-%Y',market_date) as date
,SUM(quantity*cost_to_customer_per_qty) as amt_spent
FROM customer_purchases
WHERE date = '04-2022'
GROUP BY customer_id;